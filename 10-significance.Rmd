...
It looks like our p-value is larger than the critical value $\alpha = 0.05$. So, we **cannot reject** our null hypothesis. This means that, there is a big chance of observing such a difference in mean when we have only a total of 4 data points. 
